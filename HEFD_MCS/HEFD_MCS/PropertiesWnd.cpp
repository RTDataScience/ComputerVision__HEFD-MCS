...
int CPropertiesWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
    ...
    iComboBoxProperties = 2;

    //////////////////////////////////////////////////////////////////////////
	m_wndObjectCombo.SetCurSel(2);
...
void CPropertiesWnd::InitPropListMovieFileDirectShow()
{
    ...
    static const TCHAR szFilter[] = _T("Media Files(*.avi,*.mpeg,*.mpg,*.wmv)|*.avi;*.mpeg;*.mpg;*.wmv|AVI Files(*.avi)|*.avi|MPEG Files(*.mpeg)|*.mpeg|WMV Files(*.wmv)|*.wmv|All Files(*.*)|*.*||");
...
bool CPropertiesWnd::GetPropertiesParameter()
 {
    ...
    else if ( m_wndObjectCombo.GetCurSel() == 3 )
    {
        // Device Name
        CMFCPropertyGridCtrl* pPropertyGridCtrl = NULL;
        COleVariant coleTemp;
